...
frontend:
  - task: "3D particle scroll-jacking experience + overlays"
    ...
    status_history:
        -working: "NA"
        -agent: "main"
        -comment: "Added a persistent PortfolioAILauncher directly in the main page tree at z-40, always visible above the z-0 pointer-events-none canvas; raised the AI modal to z-60. Scene3D and the 3-second morph sequence were not changed."
        -working: true
        -agent: "main"
